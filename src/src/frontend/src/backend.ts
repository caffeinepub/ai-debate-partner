...
export class Backend implements backendInterface {
    ...
    async addToDebateHistory(arg0: Debate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addToDebateHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchTopUsersByScore(arg0: bigint): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchTopUsersByScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchTopUsersByWinRate(arg0: bigint): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchTopUsersByWinRate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async makeHttpOutcall(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.makeHttpOutcall(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDebateHistory(arg0: DebateResult): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDebateHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
